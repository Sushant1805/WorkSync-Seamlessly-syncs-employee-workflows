...
const TaskList = ({title,desc}) => {
  ...
  return (
    <div className='h-full w-[300px] bg-amber-600 rounded-2xl flex-shrink-0'>
      ...
      <button className='bg-red-600  rounded-md m-2 h-10 text-xs py-1 px-2 font-semibold'>Mark As Failed</button>
      </div>
    </div>
  )
}
